...
- **多端整合包**（安卓 / Windows 优先，macOS / Linux / iOS 随后）：一个下载内含客户端 UI + 本地后端 sidecar。填 **API key + base URL** 即玩——无需命令行、无需单起服务。*（开发中——进度见 [里程碑](docs/dev/plan/milestones.md)。）*
- **自托管后端 + 浏览器**：用 docker-compose 自起 `backend`（适合远程 / 多租户），浏览器走 web 客户端玩，同样填 **API key + base URL**。*（逐步指引见 [玩家指南](wiki/玩家指南/README.md)。）*

框架强制掷骰 / 给选项、维护人物卡与剧情状态，AI 据结果叙述、不软着陆。

> **新来？** 先看这些指南——给三类使用者的任务向走查：[**玩家指南**](wiki/玩家指南/README.md)（装·起·玩一局）· [**作者指南**](wiki/作者指南/README.md)（造团本 Adventure · DIY 自定义 MCP）· [**开发指南**](wiki/开发指南/README.md)（DIY 插件 · 接口规范 · 开发示例）。
...
[`wiki/`](wiki/) 现分三域：**[项目介绍](wiki/项目介绍/)**（给所有人，是什么/为什么/服务谁）、**[玩家指南](wiki/玩家指南/README.md)** / **[作者指南](wiki/作者指南/README.md)**（任务向）和 **[开发指南](wiki/开发指南/README.md)**（对维护者的推导链：概念 → 架构 → 子系统设计，涉代码的都在这）——外加两个根级文件夹：[从SillyTavern迁移](wiki/从SillyTavern迁移/)、[预制团本说明](wiki/预制团本说明/)。设计「为什么」内嵌各设计页的*决策与权衡*节（配一份薄[决策变更日志](wiki/开发指南/决策变更日志.md)，历史记录归档）。术语单源 = 顶层[术语表](wiki/术语表.md)。
...
![跑团页](wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/play.png)

<p align="center"><sub>跑团页 · 左活动轨 · 中央叙事/打字一体 · d10 掷骰 · 右「呈现台」（网格停靠面板）· 圆形 PbtA 倒计时钟</sub></p>

![主页](wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/home.png)

<p align="center"><sub>主页 · 欢迎页 · <a href="wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/home.html">可运行草图</a></sub></p>

![团本制作](wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/build.png)

<p align="center"><sub>团本制作 · 构建台 · <a href="wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/build.html">可运行草图</a></sub></p>

![配置](wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/config.png)

<p align="center"><sub>配置 · MCP / 模型 / 主题 · <a href="wiki/开发指南/04-子系统设计/玩家客户端-视觉草图/config.html">可运行草图</a></sub></p>

<p align="center"><sub>设计语言与四页 IA → <a href="wiki/开发指南/04-子系统设计/玩家客户端-视觉.md">玩家客户端-视觉</a></sub></p>
