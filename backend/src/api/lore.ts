...
import { list, commit, tag, checkout, validatePack, validateDraft, createBuildMcpServer, invokeBuildTool, Draft, type BuildCtx, type BuildHooks, type CatalogDB, type PackFile } from "@dicelore/backend";
...
import { CLIENT_PROTOCOL, CreateSessionRequestSchema, SessionConfigUpdateSchema } from "@dicelore/shared";
