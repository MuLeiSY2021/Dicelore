...
Run:
```bash
git mv docs/wiki-old/设计/03-架构/README.md wiki/开发指南/03-架构/README.md
git mv docs/wiki-old/设计/03-架构/总体架构.md wiki/开发指南/03-架构/总体架构.md
git mv docs/wiki-old/设计/03-架构/技术选型.md wiki/开发指南/03-架构/技术选型.md
git mv "docs/wiki-old/设计/03-架构/跨agent与适配层.md" "wiki/开发指南/03-架构/跨agent与适配层.md"
git mv docs/wiki-old/设计/03-架构/dep-graph.html wiki/开发指南/03-架构/dep-graph.html
```
Expected: 无报错。
...
- [ ] **Step 1: git mv 十项(9 文件 + 1 目录),MCP工具面.md 与 Skills包.md 不在此列(留 Task 4)**

Run:
```bash
cd docs/wiki-old/设计/04-子系统设计
git mv README.md ../../../../wiki/开发指南/04-子系统设计/README.md
git mv 团本与manifest.md ../../../../wiki/开发指南/04-子系统设计/团本与manifest.md
git mv 团本构建工具链.md ../../../../wiki/开发指南/04-子系统设计/团本构建工具链.md
git mv 玩家客户端.md ../../../../wiki/开发指南/04-子系统设计/玩家客户端.md
git mv 玩家客户端-接口.md ../../../../wiki/开发指南/04-子系统设计/玩家客户端-接口.md
git mv 玩家客户端-视觉.md ../../../../wiki/开发指南/04-子系统设计/玩家客户端-视觉.md
git mv 后端双路径架构.md ../../../../wiki/开发指南/04-子系统设计/后端双路径架构.md
git mv 内层能力库.md ../../../../wiki/开发指南/04-子系统设计/内层能力库.md
git mv adapter与L3审计.md ../../../../wiki/开发指南/04-子系统设计/adapter与L3审计.md
git mv Skills-eval.md ../../../../wiki/开发指南/04-子系统设计/Skills-eval.md
git mv 玩家客户端-视觉草图 ../../../../wiki/开发指南/04-子系统设计/玩家客户端-视觉草图
cd /home/mulei/dicelore
```
Expected: 无报错。
...
Run:
```bash
git mv "docs/wiki-old/设计/04-子系统设计/MCP工具面.md" "wiki/开发指南/02-MCP与Skill体系/MCP工具面.md"
git mv "docs/wiki-old/设计/04-子系统设计/Skills包.md" "wiki/开发指南/02-MCP与Skill体系/Skills包.md"
```
Expected: 无报错。
...
Run:
```bash
git mv docs/wiki-old/设计/02-领域模型/README.md wiki/开发指南/01-核心概念/README.md
git mv docs/wiki-old/设计/02-领域模型/核心概念.md wiki/开发指南/01-核心概念/核心概念.md
```
Expected: 无报错。
...
Run:
```bash
git mv docs/wiki-old/设计/决策变更日志.md wiki/开发指南/决策变更日志.md
```
Expected: 无报错。
